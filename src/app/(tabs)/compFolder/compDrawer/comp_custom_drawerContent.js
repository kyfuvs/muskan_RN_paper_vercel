...
// import DD_css_1_basic from './dd_css_1_basic';
// import DD_css_2_advance from './dd_css_2_advance';
import { useThemeToggle } from '@/hooks/useThemeToggle';
import { Link } from 'expo-router';
 

const Comp_custom_drawerContent = ({ navigation }) => {
  ...
  return (
    <View style={{ flex: 1, flexDirection:'row', gap:5, paddingTop: 20, backgroundColor: theme.colors.background }}>
      <Link href={'https://callstack.github.io/react-native-paper/docs/components/ActivityIndicator'} target='_blank'>
      ...
      {/* <DD_css_1_basic navigation={navigation} />    
      <DD_css_2_advance navigation={navigation} />  */}
    </View>
  );
};

export default Comp_custom_drawerContent;
